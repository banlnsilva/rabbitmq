...
//        rabbitTemplate.convertAndSend("x.upbit", "upbit.ticker", dept);
//
//        Dept dept2 = new Dept(11, "testNo11", "testName11", time);
//        System.out.println("1 << 보냈음: " + dept2.toString());
//        rabbitTemplate.convertAndSend("x.upbit", "upbit.bid", dept2);
    }
}
